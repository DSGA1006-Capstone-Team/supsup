...
def main():
    ...
    config = "experiments/custom/splitcifar100/configs/rn18-supsup.yaml"
    log_dir = "runs/custom/custom_rn18-supsup"
    experiments = []
    sparsities = [4] # Higher sparsity values mean more dense subnetworks
